...
namespace Kütüphane
{
   ...
   new SqlConnection(@"Data Source=DESKTOP-I9OCSRO\MSSQLSERVER2;Initial Catalog=Kutuphane;Integrated Security=True");
	...
	catch (Exception)
	{
       ...
       baglanti.Open();
        ...
        {
            MessageBox.Show(" Enes Altun \n Mehmet Tayyip Çakmak \n Şerife Sarıkaya \n İsmail Işık");
        }
